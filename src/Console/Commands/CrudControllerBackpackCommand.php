...
class CrudControllerBackpackCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $name = 'eav:crud-controller';
     ...
     * @var string
     */
    protected $signature = 'eav:crud-controller {name} {model_namespace}';
    ...
    protected function replaceNameStrings(&$stub, $name)
    {
        ...
        $stub = str_replace('DummyModelNamespace', $this->argument('model_namespace'), $stub);
